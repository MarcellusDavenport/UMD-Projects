...
public class Entree implements Listable {
	...
	public Entree(String nameIn, SortedListOfImmutables foodListIn) {
		name = nameIn;
		foodList = new SortedListOfImmutables(foodListIn); //keeps it immutable
	}
	...
	public SortedListOfImmutables getFoodList() {
		return new SortedListOfImmutables(foodList); //keeps it immutable
	}
	...
	public boolean equals(Entree other) {
		//returns true if name of entree equals name of the entree that provokes this method
		//false if otherwise
